...
def gen_board():
    ...
    grid = pygrille.Grid(73, (9, 9), border_width=2, border_colour=(70, 70, 70), framerate=20, window_name="chess",
                         forced_window_size=(825, 825), display_offset_x=75, display_offset_y=75)
