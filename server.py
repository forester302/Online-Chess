...
def pygame_thread(ip, port):
    ...
    pygame.font.init()
    screenmanager.set_screen("run", Screens.server_running_menu(port, screenmanager))
...
def main():
    screenmanager = ScreenManager()
    screenmanager.set_screen("menu", Screens.server_main_menu(start_server, gen_new_game, screenmanager))
